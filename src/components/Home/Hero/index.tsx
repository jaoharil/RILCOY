      ...
      <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4 pt-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 space-x-1 items-center">
          <div className="col-span-6 flex flex-col gap-8 ">
            ...
            <h1 className="text-midnight_text text-4xl sm:text-5xl font-semibold pt-5 lg:pt-0">Layanan Pembuatan Website</h1>
            <h3 className="text-black/70 text-lg pt-5 lg:pt-0">Mari wujudkan website impianmu di rilCoy</h3>
            <div className="relative rounded-full pt-5 lg:pt-0">
              <input type="Email address" name="q" className="py-6 lg:py-8 pl-8 pr-20 text-lg w-full text-black rounded-full focus:outline-none shadow-input-shadow" placeholder="search website impianmu..." autoComplete="off" />
            ...
            <div className="flex items-center justify-between pt-10 lg:pt-4">
              ...
              <div className="flex gap-2">
                <Image src={`${getImagePrefix()}images/banner/check-circle.svg`} alt="check-image" width={30} height={30} className="smallImage" />
                <p className="text-sm sm:text-lg font-normal text-black">Bisnis UMKM</p>
              </div>
              <div className="flex gap-2">
                <Image src={`${getImagePrefix()}images/banner/check-circle.svg`} alt="check-image" width={30} height={30} className="smallImage" />
          ...
          <div className="col-span-6 flex justify-center">
            <Image src={`${getImagePrefix()}images/banner/baner.jpeg`} alt="nothing" width={400} height={805} />
          </div>
        </div>
      </div>
    </section>
